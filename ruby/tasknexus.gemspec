Gem::Specification.new do |s|
  s.name        = "MendilFlow"
  s.version     = "1.0.1"
  s.summary     = "MendilFlow API service (Sinatra + Mongoid + JWT)"
  s.description = "A full-featured backend API for MendilFlow, built with Sinatra, Mongoid, and JWT authentication."
